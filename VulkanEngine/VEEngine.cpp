	...
	*/
	...
	void VEEngine::loadLevel(uint32_t numLevel ) {
		...
		VESceneNode *cameraParent = getSceneManagerPointer()->createSceneNode(	"StandardCameraParent", getRoot(), 
																				glm::translate(glm::mat4(1.0f), glm::vec3(2.0f, 10.0f, 2.0f)));
		...
		light1->lookAt(glm::vec3(5.0f, 20.0f, 10.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		light1->m_col_diffuse = glm::vec4(0.9f, 0.9f, 0.9f, 1.0f);
		light1->m_col_specular = glm::vec4(0.6f, 0.6f, 0.6f, 1.0f);
